...
- ~~Hardware WORM / crypto-shred / IdP portal facades~~ — **ADR-034.** ~~SoA draft / OIDC RP~~ — **ADR-036.** ~~Auditor-signed SoA / SAML SP~~ — **ADR-041.** ~~Auditor evidence packs / SAML federation~~ — **ADR-044.** ~~Auditor-issued certs / XMLDSig~~ — **ADR-045.** Accredited ISO certs / HSM xmlsec still deferred until funded LGU deploy
