...
| C-19 | Self-hosted models via vLLM/Ollama | Adapter (behind LLMPort) | §6 Phase 3 | Foundation — ADR-016 + ADR-048 + ADR-049 soft residuals (proxy / multi / pull; seals contract-gated) |
