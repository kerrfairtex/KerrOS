...
| C-19 | Self-hosted models via vLLM/Ollama | Adapter (behind LLMPort) | §6 Phase 3 | Foundation — ADR-016–054 (offline A–E soft; live LiteLLM/llama.cpp containers still operator-owned) |
