...
- ~~Full actor orchestrator / authenticated WAN mesh~~ — foundation through [ADR-023](adr/ADR-023-actor-mesh-mtls-nats-remote.md) + [ADR-028](adr/ADR-028-actor-mesh-jetstream-otp-ca.md) (JetStream soft / OTP tree / CA reload); JetStream cluster HA / ACME still deferred
