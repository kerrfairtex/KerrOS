...
- Full A.5–A.18 control catalog / SoA — draft foundation in [soa-foundation.md](soa-foundation.md) ([ADR-036](../adr/ADR-036-soa-oidc-rp.md)); auditor signature + evidence pack foundations in [ADR-041](../adr/ADR-041-soa-audit-saml.md) / [ADR-044](../adr/ADR-044-soa-evidence-saml-federation.md); auditor-issued certificates still out of scope  
