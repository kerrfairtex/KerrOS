...
- Full A.5–A.18 control catalog / SoA — draft foundation in [soa-foundation.md](soa-foundation.md) ([ADR-036](../adr/ADR-036-soa-oidc-rp.md)); auditor signature / evidence pack / cert / XMLDSig foundations through [ADR-045](../adr/ADR-045-auditor-cert-xmldsig.md); arc complete ([ADR-046](../adr/ADR-046-mesh-lgu-foundation-arc-complete.md)); accredited ISO certificates stay contract-only  
