...
- [x] Self-hosted LLM ops (C-19) — Ollama loopback compose + health probes ([`ADR-016`](docs/adr/ADR-016-local-llm-ops.md), `deploy/ollama/`); soft vLLM kit ([`ADR-048`](docs/adr/ADR-048-vllm-ops-kit.md), `deploy/vllm/`)
