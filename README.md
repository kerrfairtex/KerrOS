...
- [x] Sealed-cold erasure review + transfer ledger — review outcomes + SCC/adequacy intents ([`ADR-026`](docs/adr/ADR-026-sealed-cold-erasure-transfers.md)); hardware WORM / auto-pipelines still deferred
